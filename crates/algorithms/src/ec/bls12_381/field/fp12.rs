//! Arithmetic over the 12th degree extension field Fp12.
//!
//! Fp12 = Fp6[w] / (w^2 - v) where v is the cubic non-residue from Fp6.
//!
//! Elements are represented as c0 + c1*w where c0, c1 ∈ Fp6.
//! This is the target field for the BLS12-381 pairing, completing the tower:
//! Fp ⊂ Fp2 ⊂ Fp6 ⊂ Fp12
...
impl Fp12 {
    ...
    /// a1*b1*w^2 = a1*b1*v which gets multiplied by the non-residue.
    #[inline]
    fn multiply_impl(&self, other: &Fp12) -> Fp12 {
...
impl Fp12 {
    ...
    /// Sparse multiplication for pairing computation
    #[inline]
    pub fn mul_by_014(&self, c0: &Fp2, c1: &Fp2, c4: &Fp2) -> Fp12 {
        self.mul_by_014_impl(c0, c1, c4)
    }
}
...
impl Fp12 {
    ...
    pub fn frobenius_map(&self) -> Self {
        ...
        // c1 *= (u + 1)^((p - 1) / 6)
        // This is the precomputed Frobenius constant for w
        let c1 = c1
            * Fp6::from(Fp2 {
...
fn test_arithmetic() {
    ...
    // Construct test values with more variation
