...
use super::{G1Affine, G2Affine, G2Projective, Scalar, BLS_X, BLS_X_IS_NEGATIVE};
...
impl MillerLoopResult {
    ...
    pub fn final_exponentiation(&self) -> Gt {
        ...
        let f = self.0;
        let t0 = f.frobenius_map().frobenius_map().frobenius_map().frobenius_map().frobenius_map().frobenius_map();
        Gt(f.invert()
            .map(|t1| {
                let mut t2 = t0 * t1;
                let t1 = t2;
                ...
                let t3 = cycolotomic_exp(t2);
                let t4 = cyclotomic_square(t3);
                let t5 = t1 * t3;
                let t1 = cycolotomic_exp(t5);
                let t0 = cycolotomic_exp(t1);
                let mut t6 = cycolotomic_exp(t0);
                t6 *= t4;
                let t4 = cycolotomic_exp(t6);
                let t5 = t5.conjugate();
                let t4 = t4 * t5 * t2;
                let t5 = t2.conjugate();
                let t1 = t1 * t2;
                ...
                let t6 = t6 * t5;
                let t6 = t6.frobenius_map();
                let t3 = t3 * t0;
                let t3 = t3.frobenius_map().frobenius_map();
                let t3 = t3 * t1;
                let t3 = t3 * t6;
                t3 * t4
            })
...
// Expanded: impl_add_binop_specify_output!(MillerLoopResult, MillerLoopResult, MillerLoopResult);
...
impl Gt {
    ...
    pub fn generator() -> Self {
        Gt(Fp12 {
            c0: Fp6 {
                c0: Fp2 {
                    c0: Fp::from_raw_unchecked([0x1972_e433_a01f_85c5, 0x97d3_2b76_fd77_2538, 0xc8ce_546f_c96b_cdf9, 0xcef6_3e73_66d4_0614, 0xa611_3427_8184_3780, 0x13f3_448a_3fc6_d825]),
                    c1: Fp::from_raw_unchecked([0xd263_31b0_2e9d_6995, 0x9d68_a482_f779_7e7d, 0x9c9b_2924_8d39_ea92, 0xf480_1ca2_e131_07aa, 0xa16c_0732_bdbc_b066, 0x083c_a4af_ba36_0478]),
                },
                c1: Fp2 {
                    c0: Fp::from_raw_unchecked([0x59e2_61db_0916_b641, 0x2716_b6f4_b23e_960d, 0xc8e5_5b10_a0bd_9c45, 0x0bdb_0bd9_9c4d_eda8, 0x8cf8_9ebf_57fd_aac5, 0x12d6_b792_9e77_7a5e]),
                    c1: Fp::from_raw_unchecked([0x5fc8_5188_b0e1_5f35, 0x34a0_6e3a_8f09_6365, 0xdb31_26a6_e02a_d62c, 0xfc6f_5aa9_7d9a_990b, 0xa12f_55f5_eb89_c210, 0x1723_703a_926f_8889]),
                },
                c2: Fp2 {
                    c0: Fp::from_raw_unchecked([0x9358_8f29_7182_8778, 0x43f6_5b86_11ab_7585, 0x3183_aaf5_ec27_9fdf, 0xfa73_d7e1_8ac9_9df6, 0x64e1_76a6_a64c_99b0, 0x179f_a78c_5838_8f1f]),
                    c1: Fp::from_raw_unchecked([0x672a_0a11_ca2a_ef12, 0x0d11_b9b5_2aa3_f16b, 0xa444_12d0_699d_056e, 0xc01d_0177_221a_5ba5, 0x66e0_cede_6c73_5529, 0x05f5_a71e_9fdd_c339]),
                },
            },
            c1: Fp6 {
                c0: Fp2 {
                    c0: Fp::from_raw_unchecked([0xd30a_88a1_b062_c679, 0x5ac5_6a5d_35fc_8304, 0xd0c8_34a6_a81f_290d, 0xcd54_30c2_da37_07c7, 0xf0c2_7ff7_8050_0af0, 0x0924_5da6_e2d7_2eae]),
                    c1: Fp::from_raw_unchecked([0x9f2e_0676_791b_5156, 0xe2d1_c823_4918_fe13, 0x4c9e_459f_3c56_1bf4, 0xa3e8_5e53_b9d3_e3c1, 0x820a_121e_21a7_0020, 0x15af_6183_41c5_9acc]),
                },
                c1: Fp2 {
                    c0: Fp::from_raw_unchecked([0x7c95_658c_2499_3ab1, 0x73eb_3872_1ca8_86b9, 0x5256_d749_4774_34bc, 0x8ba4_1902_ea50_4a8b, 0x04a3_d3f8_0c86_ce6d, 0x18a6_4a87_fb68_6eaa]),
                    c1: Fp::from_raw_unchecked([0xbb83_e71b_b920_cf26, 0x2a52_77ac_92a7_3945, 0xfc0e_e59f_94f0_46a0, 0x7158_cdf3_7860_58f7, 0x7cc1_061b_82f9_45f6, 0x03f8_47aa_9fdb_e567]),
                },
                c2: Fp2 {
                    c0: Fp::from_raw_unchecked([0x8078_dba5_6134_e657, 0x1cd7_ec9a_4399_8a6e, 0xb1aa_599a_1a99_3766, 0xc9a0_f62f_0842_ee44, 0x8e15_9be3_b605_dffa, 0x0c86_ba0d_4af1_3fc2]),
...
impl<'a> Neg for &'a Gt {
    type Output = Gt;
    #[inline]
    fn neg(self) -> Gt { Gt(self.0.conjugate()) }
}
...
impl<'a, 'b> Add<&'b Gt> for &'a Gt {
    type Output = Gt;
    #[inline]
    fn add(self, rhs: &'b Gt) -> Gt { Gt(self.0 * rhs.0) }
}

impl<'a, 'b> Sub<&'b Gt> for &'a Gt {
    type Output = Gt;
    #[inline]
    fn sub(self, rhs: &'b Gt) -> Gt { self + &(-rhs) }
}
...
impl<'a, 'b> Mul<&'b Scalar> for &'a Gt {
    ...
    fn mul(self, other: &'b Scalar) -> Self::Output {
        ...
        for bit in other.to_bytes().iter().rev().flat_map(|byte| (0..8).rev().map(move |i| Choice::from((byte >> i) & 1u8))).skip(1) {
            acc = acc.double();
...
// Expanded: impl_binops_additive!(Gt, Gt);
impl<'b> Add<&'b Gt> for Gt {
    type Output = Gt;
    #[inline]
    fn add(self, rhs: &'b Gt) -> Gt { &self + rhs }
}
impl<'a> Add<Gt> for &'a Gt {
    type Output = Gt;
    #[inline]
    fn add(self, rhs: Gt) -> Gt { self + &rhs }
}
impl Add<Gt> for Gt {
    type Output = Gt;
    #[inline]
...
impl<'a> Sub<Gt> for &'a Gt {
    type Output = Gt;
    #[inline]
    fn sub(self, rhs: Gt) -> Gt { self - &rhs }
}
impl Sub<Gt> for Gt {
    type Output = Gt;
    #[inline]
...
impl SubAssign<Gt> for Gt {
    #[inline]
    fn sub_assign(&mut self, rhs: Gt) { *self = &*self - &rhs; }
}
impl AddAssign<Gt> for Gt {
    #[inline]
    fn add_assign(&mut self, rhs: Gt) { *self = &*self + &rhs; }
}
impl<'b> SubAssign<&'b Gt> for Gt {
    #[inline]
    fn sub_assign(&mut self, rhs: &'b Gt) { *self = &*self - rhs; }
}
impl<'b> AddAssign<&'b Gt> for Gt {
    #[inline]
    fn add_assign(&mut self, rhs: &'b Gt) { *self = &*self + rhs; }
}

// Expanded: impl_binops_multiplicative!(Gt, Scalar);
impl<'b> Mul<&'b Scalar> for Gt {
    type Output = Gt;
    #[inline]
    fn mul(self, rhs: &'b Scalar) -> Gt { &self * rhs }
}
impl<'a> Mul<Scalar> for &'a Gt {
    type Output = Gt;
    #[inline]
    fn mul(self, rhs: Scalar) -> Gt { self * &rhs }
}
...
impl MulAssign<Scalar> for Gt {
    #[inline]
    fn mul_assign(&mut self, rhs: Scalar) { *self = &*self * &rhs; }
}
impl<'b> MulAssign<&'b Scalar> for Gt {
    #[inline]
    fn mul_assign(&mut self, rhs: &'b Scalar) { *self = &*self * rhs; }
}
    ...
    fn from(q: G2Affine) -> G2Prepared {
        ...
        impl MillerLoopDriver for Adder {
            ...
            fn doubling_step(&mut self, _: Self::Output) -> Self::Output {
                self.coeffs.push(doubling_step(&mut self.cur));
            }
            fn addition_step(&mut self, _: Self::Output) -> Self::Output {
                self.coeffs.push(addition_step(&mut self.cur, &self.base));
            }
    ...
    impl<'a, 'b, 'c> MillerLoopDriver for Adder<'a, 'b, 'c> {
        ...
        fn doubling_step(&mut self, mut f: Self::Output) -> Self::Output {
            for term in self.terms {
                ...
                let new_f = ell(f, &term.1.coeffs[self.index], term.0);
        ...
        fn square_output(f: Self::Output) -> Self::Output { f.square() }
        fn conjugate(f: Self::Output) -> Self::Output { f.conjugate() }
        fn one() -> Self::Output { Fp12::one() }
    }
...
pub fn pairing(p: &G1Affine, q: &G2Affine) -> Gt {
    ...
    impl<'a> MillerLoopDriver for Adder<'a> {
        type Output = Fp12;
        fn doubling_step(&mut self, f: Self::Output) -> Self::Output {
            ell(f, &doubling_step(&mut self.cur), self.p)
        }
        fn addition_step(&mut self, f: Self::Output) -> Self::Output {
            ell(f, &addition_step(&mut self.cur, &self.base), self.p)
        }
        fn square_output(f: Self::Output) -> Self::Output { f.square() }
        fn conjugate(f: Self::Output) -> Self::Output { f.conjugate() }
        fn one() -> Self::Output { Fp12::one() }
    ...
    let p_selected = G1Affine::conditional_select(p, &G1Affine::generator(), either_identity);
    let q_selected = G2Affine::conditional_select(q, &G2Affine::generator(), either_identity);

    let mut adder = Adder {
        cur: G2Projective::from(q_selected),
        base: q_selected,
        p: &p_selected,
    };
    
    let tmp = miller_loop(&mut adder);
    MillerLoopResult(Fp12::conditional_select(&tmp, &Fp12::one(), either_identity)).final_exponentiation()
}
