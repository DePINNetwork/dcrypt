...
mod tests {
    ...
    impl FieldElement {
        ...
        fn minus_one() -> Self {
            ...
            FieldElement {
                v: [
                    0x3ffffec, 0x1ffffff, 0x3ffffff, 0x1ffffff, 0x3ffffff, 0x1ffffff, 0x3ffffff,
                    0x1ffffff, 0x3ffffff, 0x1ffffff,
                ],
            }
        }
    ...
    fn test_field_element_inverse() {
        let a = FieldElement::from_bytes(&[
            171, 6, 18, 1, 21, 5, 37, 61, 10, 52, 68, 80, 26, 31, 72, 42, 10, 52, 68, 80, 17, 10,
            61, 81, 21, 5, 37, 61, 10, 52, 6, 18,
        ]);
    ...
    fn test_ref10_multiplication_coefficients() {
        ...
        let expected_bytes = FieldElement::from_bytes(&[
    ...
    fn test_reduce_once_correctness() {
        ...
        let mut p_plus_1 = FieldElement::from_bytes(&[
            0xed, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0xff, 0x7f,
        ]);
        ...
        assert_eq!(
            p_plus_small.to_bytes(),
            expected.to_bytes(),
            "p+100 should reduce to 100"
        );
    }
}
