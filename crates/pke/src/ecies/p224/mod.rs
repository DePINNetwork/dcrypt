...
impl AsRef<[u8]> for EciesP224PublicKey { fn as_ref(&self) -> &[u8] { &self.0 } }

/// Secret key for ECIES P-224. Stores serialized scalar.
#[derive(Clone, Zeroize, ZeroizeOnDrop)]
pub struct EciesP224SecretKey([u8; ec::P224_SCALAR_SIZE]);

impl AsRef<[u8]> for EciesP224SecretKey { fn as_ref(&self) -> &[u8] { &self.0 } }
...
impl Pke for EciesP224 {
    ...
    fn name() -> &'static str { "ECIES-P224-HKDF-SHA256-ChaCha20Poly1305" }
