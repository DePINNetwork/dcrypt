...
impl AsRef<[u8]> for EcdhB283kPublicKey { fn as_ref(&self) -> &[u8] { &self.0 } }
impl AsMut<[u8]> for EcdhB283kPublicKey { fn as_mut(&mut self) -> &mut [u8] { &mut self.0 } }
impl AsRef<[u8]> for EcdhB283kSecretKey { fn as_ref(&self) -> &[u8] { self.0.as_ref() } }
impl AsMut<[u8]> for EcdhB283kSecretKey { fn as_mut(&mut self) -> &mut [u8] { self.0.as_mut() } }
impl AsRef<[u8]> for EcdhB283kSharedSecret { fn as_ref(&self) -> &[u8] { self.0.as_ref() } }
impl AsMut<[u8]> for EcdhB283kSharedSecret { fn as_mut(&mut self) -> &mut [u8] { self.0.as_mut() } }
impl AsRef<[u8]> for EcdhB283kCiphertext { fn as_ref(&self) -> &[u8] { &self.0 } }
impl AsMut<[u8]> for EcdhB283kCiphertext { fn as_mut(&mut self) -> &mut [u8] { &mut self.0 } }
...
impl Kem for EcdhB283k {
    ...
    fn name() -> &'static str { "ECDH-B283k" }

    fn keypair<R: CryptoRng + RngCore>(rng: &mut R) -> ApiResult<Self::KeyPair> {
        let (sk_scalar, pk_point) = ec_b283k::generate_keypair(rng)
    ...
    fn encapsulate<R: CryptoRng + RngCore>(
        ...
        let (ephemeral_scalar, ephemeral_point) = ec_b283k::generate_keypair(rng)
            .map_err(|e| ApiError::from(KemError::from(e)))?;
        ...
        let mut kdf_ikm = Vec::with_capacity(
            ec_b283k::B283K_FIELD_ELEMENT_SIZE + 
            2 * ec_b283k::B283K_POINT_COMPRESSED_SIZE
        );
