...
/// Public key for ECDH-P384 KEM (serialized EC point)
#[derive(Clone, Zeroize)]
pub struct EcdhP384PublicKey([u8; ec_p384::P384_POINT_UNCOMPRESSED_SIZE]);
...
/// Ciphertext for ECDH-P384 KEM (ephemeral public key)
#[derive(Clone)]
pub struct EcdhP384Ciphertext([u8; ec_p384::P384_POINT_UNCOMPRESSED_SIZE]);
...
impl Kem for EcdhP384 {
    ...
    fn keypair<R: CryptoRng + RngCore>(rng: &mut R) -> ApiResult<Self::KeyPair> {
        ...
        let public_key = EcdhP384PublicKey(pk_point.serialize_uncompressed());
    ...
    fn encapsulate<R: CryptoRng + RngCore>(
        ...
        let pk_r_point = ec_p384::Point::deserialize_uncompressed(&public_key_recipient.0)
            .map_err(|e| ApiError::from(KemError::from(e)))?;
        ...
        let ciphertext = EcdhP384Ciphertext(ephemeral_point.serialize_uncompressed());
        ...
        let mut kdf_ikm = Vec::with_capacity(
            ...
            2 * ec_p384::P384_POINT_UNCOMPRESSED_SIZE
        );
    ...
    fn decapsulate(
        ...
        let q_e_point = ec_p384::Point::deserialize_uncompressed(&ciphertext_ephemeral_pk.0)
            .map_err(|e| ApiError::from(KemError::from(e)))?;
